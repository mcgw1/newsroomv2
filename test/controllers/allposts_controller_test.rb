...
class AllpostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create allpost" do
    assert_difference('Allpost.count') do
      post allposts_url, params: { allpost: { article: @allpost.article, image: @allpost.image, title: @allpost.title } }
    end
  ...
  test "should update allpost" do
    patch allpost_url(@allpost), params: { allpost: { article: @allpost.article, image: @allpost.image, title: @allpost.title } }
